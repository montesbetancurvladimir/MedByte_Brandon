...
<body>
    ...
    <main class="container">
        <div>
            ...
            <h3 class="mt-4">Lista de historias clinicas:</h3>
        </div>


        <div class="content mb-5">
            <div>
                <p class="mt-2">*Crea y configura la información de las historias clinicas.
                    <span class="texto-primario">Más informacion acerca de las historias clinicas.</span>
                </p>
                ...
                <div class="w-100 d-flex justify-content-between mt-4 align-items-center">
                    <div class="primario boton-transparente  boton-equipos ">                        
                        <a href="{{ url("HistoriaClinica/create") }}" value="Crear servicio" class="bg-transparent border-0 text-light fw-bold">
                            <i class="bi bi-plus-circle text-light"></i>  Crear Historia Clinica
                        </a>
                    </div>
                    ...
                    <table id="datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $p->descripcion }} </td>
                                <td>
                                    <a href="{{ route("HistoriaClinica.create") }}"  class="primario bg-transparent text-light fw-bold">
                                        Editar
                                    </a>
                                </td>
                            </tr>
