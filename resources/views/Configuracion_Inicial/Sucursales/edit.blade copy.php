...
<body>
    ...
    <main class="container">
        ...
        <div class="mt-3">
            <form method="POST" action="{{ route('Sucursales.store') }}" class="d-flex gap-5" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row  ancho">
                        <div class="col">
                            <div class="input-usuarios">
                                ...
                                <input type="text" name="descripcion" value="{{ $SucursalEmpresa->descripcion }}">
                            </div>
                            <div class="input-usuarios">
                                <label class="d-block" class="d-block" for="">Barrio / Sector*</label>
                                <input type="text" name="ciudad"  value="{{ $SucursalEmpresa->ciudad }}">
                            </div>

                            <div class="input-usuarios">
                                <label class="d-block" class="d-block " for="">Tipo de documento</label>
                                <select name="tipo_documento" id="" class="text-light text-center mt-1 w-100 ">
                    ...
                    <div class="row ancho">
                        <div class="col">
                            <div class="input-usuarios">
                                ...
                                <input type="text" name="pais"  value="{{ $SucursalEmpresa->pais }}">
                            </div>

                            <div class="input-usuarios">
                                <label class="d-block" for="" >Direccion*</label>
                                <input type="text" name="direccion"  value="{{ $SucursalEmpresa->direccion }}">
                            </div>

                            <div class="input-usuarios">
                                <label class="d-block" for="" name="documento">N° Documento*</label>
                                <input type="text" name="documento"  value="{{ $SucursalEmpresa->documento }}">
                            </div>
                    ...
                    <div class="row ancho">
                        <div class="col">
                            <div class="input-usuarios">
                                ...
                                <input type="text" name="municipio"  value="{{ $SucursalEmpresa->municipio }}">
                            </div class="input-usuarios">

                            <div class="input-usuarios">
                                <label class="d-block" for="">Telefono*</label>
                                <input type="text" name="telefono"  value="{{ $SucursalEmpresa->telefono }}">
                            </div class="input-usuarios">

                            <div class="input-usuarios">
                                <label class="d-block" for="">Razon social*</label>
                                <input type="text" name="razon_social"  value="{{ $SucursalEmpresa->razon_social }}">
                            </div class="input-usuarios">

                            <div class="input-usuarios">
                                <label class="d-block" for="">Subir foto de la sede</label>
