                    ...
                    <div class="row  ancho">
                        <div class="col">
                            ...
                            <div class="input-usuarios">
                                ...
                                <select name="tipo_documento" id="" class="form-select" required autofocus>
                            ...
                            <div class="d-flex gap-3 mt-5">
                                <label class="d-block" class="d-block">Estado sede:</label>
                                <div class="d-flex gap-2">
                                    <input type="radio" name="estado_sede" value="1"> Activo.
                                    <input type="radio" name="estado_sede" value="0"> Inactivo.
                                </div>
                              
                            </div>

                            <div class="d-flex gap-3 mt-3">
                                <label class="d-block" class="d-block">Tipo de sede:</label>
                                <div class="d-flex gap-2">
                                    <input type="radio" name="tipo_sede" value="1."> Principal.
                                    <input type="radio" name="tipo_sede" value="0"> Otra.
                                </div>
                    ...
                    <div class="row ancho">
                        <div class="col">
                            ...
                            <div class="input-usuarios">
                                ...
                                <input type="text" name="direccion" required autofocus>
                            </div>
                    ...
                    <div class="row ancho">
                        <div class="col">
                            ...
                            <div class="input-usuarios">
                                ...
                                <input type="text" name="telefono" required autofocus>
                            </div class="input-usuarios">

                            <div class="input-usuarios">
                                <label class="d-block">Razon social*</label>
                                <input type="text" name="razon_social" required autofocus>
                            </div class="input-usuarios">

                            <div class="input-usuarios">
                                <label class="d-block">Cargar foto de la sede</label>
