...
<body>
    ...
    <main class="container">
        ...
        <div>
            <form method="POST" action="{{ route('Medicos.store') }}" class="d-flex gap-5">
                @csrf
                <div class="d-flex gap-2 align-items-center">

                    <div class="d-flex flex-column gap-3">
                        <div>
                            <input type="checkbox" name="lunes" id="">
                            <label for="">Lunes</label>
                        </div>
                        <div>
                            <input type="checkbox" name="martes" id="">
                            <label for="">Martes</label>
                        </div>
                        <div>
                            <input type="checkbox" name="miercoles" id="">
                            <label for="">Miercoles</label>
                        </div>
                        <div>
                            <input type="checkbox" name="jueves" id="">
                            <label for="">Jueves</label>
                        </div>
                        <div>
                            <input type="checkbox" name="viernes" id="">
                            <label for="">Viernes</label>
                        </div>
                        <div>
                            <input type="checkbox" name="sabado" id="">
                            <label for="">Sabado</label>
                        </div>
                        <div>
                            <input type="checkbox" name="domingo" id="">
