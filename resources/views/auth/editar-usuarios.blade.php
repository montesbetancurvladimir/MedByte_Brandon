...
<body>
    ...
    <main class="container">
        ...
        <div>
            <form method="POST" action="{{ route('User.update',$User->id) }}" class="d-flex gap-5" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="row  ancho">
                    <div class="col">
                        <div class="input-usuarios">
                            ...
                            <input name="nombre1" type="text" value="{{ $User->nombre1 }}">
                        </div>
                        ...
                        <div class="input-usuarios">
                            ...
                            <select name="tipo_documento_id" class="form-select">
                                @foreach ($tipo_documento_id as $descripcion => $id)
                                    <option {{$User->tipo_documento_id == $id ?  'selected' : ''}} value="{{ $id}}">{{$descripcion}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="input-usuarios">
                            ...
                            <input name="numero_id" type="text" value="{{ $User->numero_id}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row ancho">
                    <div class="col">
                        <div class="input-usuarios">
                            ...
                            <input name="nombre2" type="text" value="{{ $User->nombre2}}">
                        </div>

                        <div class="input-usuarios">
                            <label class="d-block" for="">Celular*</label>
                            <input name="celular" type="text" value="{{ $User->celular}}">
                        </div>

                        <div class="input-usuarios">
                            <label class="d-block" for="">No. Tarjeta Profesional*</label>
                            <input name="tarjeta_profesional" type="text" value="{{ $User->tarjeta_profesional}}">
                        </div>

                        <div class="input-usuarios">
                            <label class="d-block" for="">Cambio del estado de registro</label>
                            <input  {{$User->activo == "1" ?  'checked' : ''}} type="radio" name="activo" value="1">Activo.
                            <input  {{$User->activo == "0" ?  'checked' : ''}} type="radio" name="activo" value="0">Inactivo.
                        </div>
                ...
                <div class="row ancho">
                    <div class="col">
                        ...
                        <div class="input-usuarios">
                            <label class="d-block" for="">Cargar foto de perfil</label>
                            <input type="file" name="foto_perfil" value="{{ old("foto_perfil","")}}">
                        </div>
                    </div>
                </div>
