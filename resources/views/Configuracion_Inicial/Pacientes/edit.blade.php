                ...
                <div class="row  ancho">
                    <div class="col">
                        <div class="input-usuarios">
                            ...
                            <input name="nombre1" type="text" value="{{  $Paciente->nombre1 }}" required autofocus>
                        </div>

                        <div class="input-usuarios">
                            <label class="d-block" for="">Segundo Apellido*</label>
                            <input name="apellido2" type="text" value="{{ $Paciente->apellido2}}" required autofocus>
                        </div>

                        <div class="input-usuarios">
                            <label class="d-block" for="">Fecha de nacimiento*</label>
                            <input name="fecha_nacimiento" type="date" value="{{$Paciente->fecha_nacimiento}}" required autofocus>
                        </div>

                        <div class="input-usuarios">
                            <label class="d-block" for="">Teléfono*</label>
                            <input name="telefono" type="text" value="{{$Telefono->descripcion}}" required autofocus>
                        </div>
                        ...
                        <div class="input-usuarios">
                            ...
                            <select name="pais" id="_pais"  class="form-select" required autofocus>
                                ...
                                <option {{$Direccion->pais_id == $item->id ?  'selected' : ''}} value="{{$item->id}}">{{$item->descripcion}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row ancho">
                    <div class="col">
                        <div class="input-usuarios">
                            ...
                            <input name="nombre2" type="text" value="{{$Paciente->nombre2}}">
                        </div>
                    </div>
                    <div class="input-usuarios">
                        ...
                        <select name="tipo_documento_id" class="form-select" required autofocus>
                            ...
                            @foreach ($tipo_documento_id as $descripcion => $id)
                                <option {{$Paciente->tipo_documento_id == $id ?  'selected' : ''}} value="{{ $id }}">{{ $descripcion }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="input-usuarios">
                        ...
                        <input name="email" type="email" value="{{$Correo->descripcion}}" required autofocus>
                    </div>

                    <div class="input-usuarios">
                        <label class="d-block" for="">Municipio*</label>
                        <select name="municipio" id="_departamento" class="form-select" required autofocus>
                            @foreach ($departamentos as $item)
                                <option {{$Direccion->municipio_id == $item->id ?  'selected' : ''}} value="{{$item->id}}">{{$item->descripcion}}</option>
                            @endforeach
                        </select>
                    </div class="input-usuarios">
                </div>
                ...
                <div class="row ancho">
                    <div class="col">
                        <div class="input-usuarios">
                            ...
                            <input name="apellido1" type="text" value="{{ $Paciente->apellido1}}" required autofocus>
                        </div>
                    </div>
                                        
                    <div class="input-usuarios">
                        <label class="d-block" for="">Documento Identificación*</label>
                        <input name="numero_id" type="text" value="{{$Paciente->documento }}" required autofocus>
                    </div>

                    <div class="col">
                        <div class="input-usuarios">
                            <label class="d-block" class="d-block" for="">Tipo de sangre*</label>
                            <input name="tipo_sangre" type="text" value="{{ $Paciente->tipo_sangre }}" required autofocus>
                        </div>
                    </div>

                    <div class="input-usuarios">
                        <label class="d-block" for="">Dirección*</label>
                        <input name="direccion" type="text" value="{{$Direccion->descripcion}}" required autofocus>
                    </div>

                    <div class="input-usuarios">
                        <label class="d-block" class="d-block" for="">Barrio / Sector*</label>
                        <select name="ciudad" id="_municipio"  class="form-select" required autofocus>
