...
<body>
    ...
    <main class="container">
        ...
        <div>
            <form method="POST" action="{{ route('User.store') }}" class="d-flex gap-5" enctype="multipart/form-data">
                @csrf
                <div class="row  ancho">
                    <div class="col">
                        ...
                        <div class="input-usuarios">
                            ...
                            <input name="numero_id" type="text" value="{{ old("numero_id","")}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row ancho">
                    <div class="col">
                        ...
                        <div class="input-usuarios">
                            ...
                            <input name="tarjeta_profesional" type="text" value="{{ old("tarjeta_profesional","")}}">
                        </div>

                        <div class="input-usuarios">
                            <label class="d-block" for="">Cambio del estado de registro</label>
                            <input type="radio" name="activo" value="1">Activo.
